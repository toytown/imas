...
/**
 * Extension of {@link SubmitLink}, that renders as a button defined in WEP styleguide and additionaly allows to define JavaScript invoked onClick
 * by exposing {@link #getOnClickJavaScript} method to override. 
 */
public class WepJsButton extends SubmitLink {

    private static final long serialVersionUID = 958490845467804602L;
    ...
    /**
     * Returns the javascript to be triggered onClick of the button.
     * This is typically the method to be overriden by subclasses. 
     * In a default implementation it just behaves as {@link SubmitLink}
     * @return
     */
