...
public class DatePickerSettings implements Serializable {
    ...
    static {
        ...
        localeToLanguageReference.put(new Locale("no", "", "").toString(), "lang/calendar-no-utf8.js");
     ...
     * element. It might overlap it (that depends on the horizontal alignment).</li>
     * <li>b -- below the element but may overlap it (top margin of the calendar
     * aligned to the top margin of the element).</li>
     * <li>B -- completely below the element (top margin of the calendar aligned
     * to the bottom margin of the element).</li>
     * </ul>
     * </p>
     * <p>
     ...
     * <ul>
     * <li>L -- completely to the left of the reference element (right margin of
